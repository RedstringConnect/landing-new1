...
export function FinalCTA() {
  ...
  return (
    <section className="py-28 relative px-6 w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20" id="cta">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20 z-10 relative">
        {/* Left Column */}
        <div className="flex-1 flex flex-col items-start w-full">
          <h2
            className="font-bold font-denton text-foreground text-4xl md:text-5xl lg:text-6xl leading-tight max-w-xl"
