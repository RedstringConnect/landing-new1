        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <a href="https://instagram.com/redstring.hire" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-border flex items-center justify-center hover:bg-muted transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
